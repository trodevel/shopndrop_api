<?php
// $Revision: 11517 $ $Date:: 2019-05-19 #$ $Author: serge $

namespace shopndrop_api;

require_once __DIR__.'/api.php';

function get_shopping_request_info( & $api, $session_id, $ride_id, & $resp )
{
    // execute request
    ...
    elseif( get_class( $resp ) == "shopndrop_protocol\web\GetShoppingRequestInfoResponse" )
    {
    }
    else
    {
...
function get_shopping_request_info_auto( $host, $port, $login, $password, $ride_id, & $resp )
{
    ...
    {
        $res = get_shopping_request_info( $api, $session_id, $ride_id, $resp );
