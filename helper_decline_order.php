<?php
// $Revision: 11526 $ $Date:: 2019-05-19 #$ $Author: serge $

namespace shopndrop_api;

require_once __DIR__.'/api.php';

function decline_order( & $api, $session_id, $order_id, & $resp )
{
    // execute request

    $req = new \shopndrop_protocol\DeclineOrderRequest( $session_id, $order_id );
...
function decline_order_auto( $host, $port, $login, $password, $order_id, & $resp )
{
    ...
    {
        $res = decline_order( $api, $session_id, $order_id, $resp );
