<?php
// $Revision: 11532 $ $Date:: 2019-05-20 #$ $Author: serge $

namespace shopndrop_api;

require_once __DIR__.'/api.php';

function cancel_order( & $api, $session_id, $order_id, & $resp )
{
    // execute request

    $req = new \shopndrop_protocol\CancelOrderRequest( $session_id, $order_id );
...
function cancel_order_auto( $host, $port, $login, $password, $order_id, & $resp )
{
    ...
    {
        $res = cancel_order( $api, $session_id, $order_id, $resp );
